...
1) **Immediate feedback for a user action that just happened?**

- Yes -> **Toast** (B)
- No -> continue

1) **Tied to a specific screen/constraint/validation that persists?**

- Yes -> **Inline Alert** (C)
- No -> continue

1) **Relevant later (reviewable) or only ambient now?**
